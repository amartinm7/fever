...
cmdStartDocker="docker-compose up -d"
...
openNewTab "$cmdStartDocker; docker-compose logs -f database"
openNewTab "$cmdStartDocker; docker-compose logs -f wiremock"
openNewTab "$cmdStartDocker; docker-compose logs -f fever"
